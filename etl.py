...
def process_song_file(cur, filepath):
    """
    Function that will perform ETL song files. Outputs record to 
    both the songs able and artists table.

    Parameters: 
    - cur: connection to DB
    - filepath (string): path of a song data file, ex. song_data/TRAAAAW128F429D538.json
    """
