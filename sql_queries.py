...
# ON CONFLICT Eliminate Repeated fields/
...
# FIND SONGS
song_select = ("SELECT s.song_id, a.artist_id from songs as s JOIN artists a on s.artist_id = a.artist_id WHERE s.title = %s AND a.name = %s AND s.duration = %s")
